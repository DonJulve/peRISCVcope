...
void execute_load(mem::memory& mem, processor& proc, mem::address_t addr, uint8_t rd);

// store
template<uint8_t funct3>
void execute_store(mem::memory& mem, processor& proc, mem::address_t addr, uint8_t rs2);
...
using execute_func = std::function<uint32_t(mem::memory& mem, processor& proc, uint32_t)>;
